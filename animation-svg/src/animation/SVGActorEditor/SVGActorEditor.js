  ...
  componentWillReceiveProps(newProps) {
    if (this.props.selectedActor !== null && newProps.selectedActor !== null) {
      if (newProps.selectedActor.id !== this.props.selectedActor.id) {
        this.setState({ xPosition: newProps.selectedActor.xPosition });
      }
    }
  }
            ...
            <div className="row">
              <div className="col-lg-9 mt-4 ">
                <InputRange
                  ...
                  onChangeComplete={xPosition =>
                    this.props.changeXposition(xPosition)
                  }
                />
              </div>
              <div className="col-lg-3 mt-3">
                ...
                <input
                  ...
                  value={this.props.selectedActor.xPosition}
                  onChange={value => this.props.changeXposition(value)}
                />
              </div>
            </div>
          </React.Fragment>
