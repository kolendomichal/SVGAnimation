...
function SVGSquare(props) {
    ...
    return (
        <polygon  opacity={figure.opacity}  fill={figure.fill.hex} stroke={figure.stroke.hex} strokeWidth={figure.strokeWidth} points={computeCornerPoints(figure.xPosition, figure.yPosition, 50)} className={animStyleName + " figure"} />
    )
}
